...
if report:
    ...
    with open(full_path, "w") as log:
        ...
        for line in report:
            # we do not need to use writelines since we are looping through each element of report with /n
            log.write(line + "\n")
else:
